...
define('tribute/routes/hero', ['exports', 'ember'], function (exports, _ember) {
  exports['default'] = _ember['default'].Route.extend({
    model: function model(params) {
      return _ember['default'].RSVP.cast(_ember['default'].$.getJSON('https://api.opendota.com/api/heroStats')).then(function (results) {
        var myHero = results.filter(function (hero) {
...
define('tribute/routes/lich', ['exports', 'ember'], function (exports, _ember) {
  exports['default'] = _ember['default'].Route.extend({
    model: function model() {
      return _ember['default'].RSVP.cast(_ember['default'].$.getJSON('https://api.opendota.com/api/heroStats')).then(function (results) {
        var myHero = results.filter(function (hero) {
          return Number(hero.hero_id) === Number(31);
        });
...
define('tribute/routes/necrophos', ['exports', 'ember'], function (exports, _ember) {
  exports['default'] = _ember['default'].Route.extend({
    model: function model() {
      return _ember['default'].RSVP.cast(_ember['default'].$.getJSON('https://api.opendota.com/api/heroStats')).then(function (results) {
        var myHero = results.filter(function (hero) {
          return Number(hero.hero_id) === Number(36);
        });
...
define('tribute/routes/treant', ['exports', 'ember'], function (exports, _ember) {
  exports['default'] = _ember['default'].Route.extend({
    model: function model() {
      return _ember['default'].RSVP.cast(_ember['default'].$.getJSON('https://api.opendota.com/api/heroStats')).then(function (results) {
        var myHero = results.filter(function (hero) {
          return Number(hero.hero_id) === Number(83);
        });
...
if (!runningTests) {
  require("tribute/app")["default"].create({"name":"tribute","version":"0.0.0+db7848b8"});
}
