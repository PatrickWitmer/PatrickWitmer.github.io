...
define('tribute/tests/routes/hero.jshint.lint-test', ['exports'], function (exports) {
  'use strict';

  QUnit.module('JSHint | routes/hero.js');
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(true, 'routes/hero.js should pass jshint.');
  });
});
...
define('tribute/tests/unit/routes/hero-test', ['exports', 'ember-qunit'], function (exports, _emberQunit) {

  (0, _emberQunit.moduleFor)('route:hero', 'Unit | Route | hero', {
...
define('tribute/tests/unit/routes/hero-test.jshint.lint-test', ['exports'], function (exports) {
  'use strict';

  QUnit.module('JSHint | unit/routes/hero-test.js');
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/routes/hero-test.js should pass jshint.');
  });
});
